...
class AboutUsCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setRoute(config('backpack.base.route_prefix') . '/aboutus');
        CRUD::setEntityNameStrings('aboutus', 'about_uses');
    }
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::addField([
            'name'=>'AboutTitreMotivation',
            'label'=>'Titre de la motivation',
            'type'=>'text'
        ]);
        CRUD::addField([
            'name'=>'aboutMotivation',
            'label'=>'Contenu de la motivation',
            'type'=>'tinymce'
        ]);
    }
